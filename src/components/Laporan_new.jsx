  ...
  const fetchReports = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        toast.success(
          `Berhasil memuat ${response.data.data.length} data laporan`,
        );
      } else {
      ...
      <html>
        ...
        <body>
          ...
          <div class="summary">
            ...
            <p><strong>Total Pendapatan:</strong> Rp ${summary.totalRevenue.toLocaleString(
              'id-ID',
            )}</p>
              ...
              {reports.length === 0 ? (
                <div className="text-center py-8 bg-white rounded-lg shadow-lg">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Coba pilih periode lain atau pastikan ada transaksi yang
                    sudah dibayar
                  </p>
                </div>
              ) : (
