...
const ProductCard = ({ name, description, price, features, img }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-4 w-full md:w-80 lg:w-96 xl:w-[24rem]">
...
const ProductCategory = () => {
  ...
  <div className="bg-white py-8 px-12 pt-28 pb-12">
    ...
    <p className="text-gray-600 mb-2">Dari Pembuatan Domain hingga Web Hosting dan Layanan Digital Lainnya, Kami Hadir</p>
    <p className="text-gray-600 mb-2">untuk Membantu Anda Membangun dan Mengoptimalkan Kehadiran Online dengan Solusi</p>
    <p className="text-gray-600 mb-8">yang Dapat Diandalkan, Cepat, dan Mendukung Pertumbuhan Bisnis Anda di Era Digital.</p>
    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mx-20">
